...
describe('GrpcComponent', () => {
    ...
    it('defines grpc component configurations', () => __awaiter(this, void 0, void 0, function* () {
        const app = givenApplication();
        const lbGrpcServer = yield app.getServer('GrpcServer');
        testlab_1.expect(lbGrpcServer.getSync(__1.GrpcBindings.PORT)).to.be.eql(8080);
    }));
    // LoopBack GRPC Service
    it('creates a grpc service', () => __awaiter(this, void 0, void 0, function* () {
    ...
    // LoopBack GRPC Service
    it('creates a grpc service with custom sequence', () => __awaiter(this, void 0, void 0, function* () {
        // Define Greeter Service Implementation
        class GreeterCtrl {
            // Tell LoopBack that this is a Service RPC implementation
            sayHello(request) {
        ...
        let MySequence = class MySequence {
            ...
            unaryCall(call) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    const reply = yield this.method(call.request);
